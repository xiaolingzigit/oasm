...
<body>
	<!--个人信息管理 -->
				...
				<tr>
				<td rowspan="5"><img src="<c:url value='/resource/images/police_icon2.jpg'/>"  width="100%"></td>
				...
				$('#set_pwd').click(function (event) {
					$('#set_userPwd').addClass('option_li_current').siblings().removeClass('option_li_current');
