	...
	<div class="layer02">
		...
		<div class="search_area">
			<div style="float:left;" class="search_sub1">
				监区: <select id="rjpgWp_ss_selected">
			...
			<div style="float:left;" class="search_sub1">
				囚号:<input type="text" id="rjpgWpqh"/>
			</div>
			<div style="float:left;" class="search_sub1">
				罪犯姓名：<input type="text" id="rjpgWpxm"/>
			</div>
			<div style="float:left;" class="search_sub1">
				专管警察：<input type="text" id="rjpgWpjc"/>
			</div>
			<div style="float:left;" class="search_sub1">
				<button class="button_submit2" id="rjpgWp_ss_btn">搜索</button>
			</div>
			<div class="search_sub2" id="rjpgWp_ss_radio">
				<span>审核情况:</span>
				<input type="radio" name="wp" value="" checked="checked"/><label for="auditStatus_all">全部 </label>
				<input type="radio" name="wp" value="1" /><label for="auditStatus_1">已审核</label>
				<input type="radio" name="wp" value="0" /><label for="auditStatus_0">未审核</label>
				<span style="margin-left:20px">危险等级：</span>
				<input type="radio" name="wxdj" value="" checked="checked"/><label for="wxdj_all">全部</label> 
				<input type="radio" name="wxdj" value="极高危险" /><label for="wxdj_4">极高危险</label>
				<input type="radio" name="wxdj" value="高度危险" /><label for="wxdj_3">高度危险</label>
				<input type="radio" name="wxdj" value="中度危险" /><label for="wxdj_2">中度危险</label>
				<input type="radio" name="wxdj" value="低度危险" /><label for="wxdj_1">低度危险</label>			
			</div>
				...
				<div id="jgfttab" class="option_table3">
					<table class="content_table" width="100%">
						<tr>
							...
							<th class="base_th" width="10%">审核状态</th>							
						...
						<tr>
							...
							<td>已审核</td>
							<td><a href="#"
								onclick="loadnext3('/oasm/bgspView/rj_bgsprs')">查看详情</a></td>
						</tr>
						<tr>
							<td>6546566454101</td>
							<td>6546545454</td>
							...
							<td>卫武</td>
							<td>未审核</td>
							<td><div class="addbutton2"onclick="loadnext3('/oasm/bgspView/rj_bgsplr')">
							意见录入</div>
					        </td>
					     </tbody>
						</table>
