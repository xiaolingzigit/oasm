	...
	<!--心理测试 -->
		...
		<div class="search_area">
			...
			<div  class="search_sub2">
				测试情况：<input type="radio" name="csqk" value=""/> 全部 <input type="radio" name="csqk" value="" /> 已测试<input
					type="radio" name="csqk" value="" /> 未测试
			</div>
				...
				<div id="xlcstab" class="option_table3">
					<table class="content_table" width="100%">
						...
						<tr>
							...
							<td>王峰</td>
							<td>未测试</td>
							<td><div class="addbutton2"onclick="loadnext3('/oasm/xljzView/xlcs_shsylb')">
							进入测试</div>
					        </td>
						</table>
