...
<body>
	<div id="" class="sub-block">
		...
		<div class="location">
			...
			<div class="location_right">
				<strong>&nbsp;&nbsp;统计分析 >><font color="#ff3300">危险等级统计</font></strong>
			</div>
		</div>
		...
		<div class="search_title">统计条件：</div>
			...
			<!-- table -->
			<div id="bar" style="width: 100%; height:300px;clear:both"></div>
			...
			<h4>危险等级统计表</h4>
				...
				<table width="100%">
					<tr>
						...
						<th class="base_th" width="9%">极高度危险比例</th>
						<th class="base_th" width="9%">极高度危险人数</th>
						<th class="base_th" width="8%">高度危险比例</th>
						<th class="base_th" width="8%">高度危险人数</th>
						<th class="base_th" width="8%">中度危险比例</th>
						<th class="base_th" width="8%">中度危险人数</th>
						<th class="base_th" width="8%">低度危险比例</th>
						<th class="base_th" width="8%">低度危险人数</th>
						<th class="base_th" width="8%">未测试人员比例</th>
						<th class="base_th" width="8%">未测试人员人数</th>
	...
	<script type="text/javascript"
		src="<c:url value="/resource/js/tjfx/wpcdtj.js"/>"></script>
	<script type="text/javascript"
