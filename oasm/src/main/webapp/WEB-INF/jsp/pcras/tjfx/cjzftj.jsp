...
<body>
	<div id="" class="sub-block">
		...
		<div class="main_content">
					...
					<div class="sub_search_area">
						<table class="tjsetting_tb">
							...
							<tr>
								<th>评估时间段</th>
								<td>
									<input type="text" class="select_time search_tb_input"
			...
			<div class="base_table">
				...
				<table width="100%">
					<tr>
						<th class="base_th" width="10%" rowspan="2">监区</th>
						<th class="base_th" width="20%" colspan="2">极高度倾向</th>
						<th class="base_th" width="20%" colspan="2">高度倾向</th>
						<th class="base_th" width="20%" colspan="2">中度倾向</th>
						<th class="base_th" width="20%" colspan="2">低度倾向</th>
						<th class="base_th" width="10%" rowspan="2">总人数</th>
					</tr>
					<tr>
	...
	<script type="text/javascript"
	src="<c:url value="/resource/js/tjfx/cjzftj.js"/>"></script>
</body>
</html>