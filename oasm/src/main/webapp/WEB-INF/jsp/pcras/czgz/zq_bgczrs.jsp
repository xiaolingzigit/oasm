...
<title>中期评估处置跟踪</title>

</head>
<body>
    <div class="return_btn" >
       <a href="#" onclick="loadnext3('/oasm/czgzView/zq_bgcz')"> <<<  返回 </a>	
    </div>
     <div class="rs_table">
        <div class="rs_table_title"><h1>中期评估处置跟踪情况</h1></div>
		  <div class="msg_div2">
		   <ul  class="xx_ul">
		   ...
		   <li class="xx_li02 xx_number" onclick="loadnext3('/oasm/pgbgsccxView/pgbg_zq')">6546545454101</li>
