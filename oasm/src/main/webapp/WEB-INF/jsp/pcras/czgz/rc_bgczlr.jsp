...
<title>日常评估处置跟踪</title>

</head>
<body>
	<div class="return_btn">
		<a href="#" onclick="loadnext3('/oasm/czgzView/rc_bgcz')"> <<< 返回
		</a>
	</div>
	<div class="rs_table">
		...
		<div class="rs_table_title">
		  ...
		  <div class="msg_div2">
		   ...
		   <li class="xx_li02 xx_number" onclick="loadnext3('/oasm/pgbgsccxView/pgbg_rc')">6546545454101</li>
