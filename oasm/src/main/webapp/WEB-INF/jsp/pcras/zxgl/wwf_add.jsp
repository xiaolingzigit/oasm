	...
	<!--顽危犯认定 -->
		...
		<div class="search_area">
			...
			<div class="search_sub2">
				...
				<span style="margin-left:20px">认定情况：
				</span><input type="radio" name="wxdj" value="" /> 全部 
				<input type="radio" name="wxdj" value="" /> 未认定
				<input type="radio" name="wxdj" value="" /> 认定中
			</div>
		</div>
		</div>
				<!--顽危犯认定 -->
				<div id="zftab" class="option_table3">
					<table class="content_table" width="100%">
								<tr>
									...
									<th class="base_th" width="10%">认定状态</th>
								...
								<tr>
									...
									<td>刘瑾言</td>
									<td>未认定</td>
									<td><div class="addbutton2"onclick="loadnext3('/oasm/zxglView/wwf_addlr')">
							                         认定</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>刘瑾言</td>
									<td>认定中</td>
									<td><a href="#" onclick="loadnext3('/oasm/zxglView/wwf_addrs')">查看详情</a>
									</td>
								</tr>
							</table>
