	...
	<div class="layer02">
		...
		<div class="search_area">
			<div style="float:left;" class="search_sub1">
				监区: <select id="rjpgHy_ss_selected">
			...
			<div style="float:left;" class="search_sub1">
				囚号:<input type="text" id="rjpgHyqh"/>
			</div>
			<div style="float:left;" class="search_sub1">
				罪犯姓名：<input type="text" id="rjpgHyxm"/>
			</div>
			<div style="float:left;" class="search_sub1">
				专管警察：<input type="text" id="rjpgHyjc"/>
			</div>
			<div style="float:left;" class="search_sub1">
				<button class="button_submit2" id="rjpgHy_ss_btn">搜索</button>
			</div>
			<div class="search_sub2" id="rjpgHy_ss_radio">
				<span>审核情况:</span>
				<input type="radio" name="hy" value=""  checked="checked"/> 全部 
				<input type="radio" name="hy" value="1" /> 已审核
				<input type="radio" name="hy" value="0" /> 未审核
				...
				<div id="jgfttab" class="option_table3">
					<table class="content_table" width="100%">
						...
						<tr>
							...
							<td>卫武</td>
							<td>已审核</td>
							<td><a href="#" onclick="loadnext3('/oasm/fyhyView/rj_bghyrs')">查看详情</a></td>
						</tr>
						<tr>
							<td>6546566454101</td>
							<td>6546545454</td>
							...
							<td>卫武</td>
							<td>未审核</td>
							<td><div class="addbutton2"onclick="loadnext3('/oasm/fyhyView/rj_bghylr')">意见录入</div>
					        </td>
