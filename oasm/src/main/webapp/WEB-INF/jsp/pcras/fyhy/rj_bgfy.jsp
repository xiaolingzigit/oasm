	...
	<div class="layer02">
		...
		<div class="search_area">
			...
			<div class="search_sub2">
				<span>复议情况:</span>
				<input type="radio" name="csqk" value="" /> 已复议
				<input type="radio" name="csqk" value="" /> 未复议
				<input type="radio" name="csqk" value="" /> 全部 
				<span style="margin-left:20px">危险等级：</span><input type="radio" name="wxdj" value="" /> 全部 
				...
				<div id="jgfttab" class="option_table3">
					<table class="content_table" width="100%">
						<tr>
							...
							<th class="base_th" width="10%">复议状态</th>							
						...
						<tr>
							...
							<td>已复议</td>
							<td><a href="#"
								onclick="loadnext3('/oasm/fyhyView/rj_bgfyrs')">查看详情</a></td>
						</tr>
						<tr>
							<td>6546566454101</td>
							<td>6546545454</td>
							...
							<td>卫武</td>
							<td>未复议</td>
							<td><div class="addbutton2"onclick="loadnext3('/oasm/fyhyView/rj_bgfylr')">
							意见录入</div>
					        </td>
						</table>
