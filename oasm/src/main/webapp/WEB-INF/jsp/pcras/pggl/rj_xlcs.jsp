		...
		<div class="search_area">
			<fieldset class="instruct">
				<table class="search_tb">
					<tr>
						<th>监&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;区</th>
						<td><select id="rjxlcs_ss_selected" class="search_tb_select">
					...
					<option value="狱政科">狱政科</option>
						...
						<th>囚&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号</th>
						<td><input type="text" id="rjxlcsqh" class="search_tb_input" /></td>
						<th>罪&nbsp;&nbsp;犯&nbsp;&nbsp;姓&nbsp;&nbsp;名</th>
						<td><input type="text" id="rjxlcsxm" class="search_tb_input" /></td>
						<th>警&nbsp;&nbsp;察&nbsp;&nbsp;姓&nbsp;&nbsp;名</th>
						<td><input type="text" id="rjxlcsjhxm" class="search_tb_input" /></td>
					</tr>
					<tr>
						<th>测&nbsp;&nbsp;试&nbsp;&nbsp;状&nbsp;&nbsp;态</th>
						<td colspan="5" id="rjxlcs_ss_radio"><input type="radio" name="wcqk" value="" id="status_all" checked/> <label for="status_all">全部 </label>
				    ...
				    <input type="radio" name="wcqk" value="10" id="status_10" /><label for="status_10">已取消</label></td>
						<td><button class="button_submit2" id="rjxlcs_ss_btn">&nbsp;搜&nbsp;&nbsp;索&nbsp;</button></td>
					</tr>
					</table>
			</fieldset>
		</div>
				...
				<div id="xlcstab" class="option_table3">
					<table class="content_table" width="100%">
						<tr>
							...
							<th class="base_th" width="10%">新收押量表得分</th>
