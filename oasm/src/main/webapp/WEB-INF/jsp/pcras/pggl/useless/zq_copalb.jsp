...
<body>
    <div class="return_btn" >
       <a href="#" onclick="loadnext3('/oasm/dafxView/zq_copa')"> <<<  返回 </a>	
    </div>
     <div class="rs_table">
        <div class="rs_table_title"><h1>COPA-PI量表</h1></div>
         <div class="table_msg" >
	...
	<legend>指导语</legend>
<p><strong><u>填写说明</u></strong></p>
<p>&nbsp;&nbsp;下面每道题均设有“是”和“否”两个答案，放在每道题的题号前边。请阅读每道题并考虑它是否符合你自己的实际情况或看法。如果某道题符合或更倾向于符合你的实际情况或看法，请选中题号后边的 “是”；如果不符合或更倾向于不符合你的情况，请选中题号后边的“否”。请看例子：</p>
 <p>例子：我喜欢看电视。<input name="example" type="radio" value="1"  checked />是&nbsp;<input name="example" type="radio" value="2" />否  </p>
