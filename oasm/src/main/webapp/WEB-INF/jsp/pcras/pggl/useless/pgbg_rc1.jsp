...
<!-- 功能子块-->
	...
	<div class="main_content">
			<div class="cs-jc-title">罪犯日常危险性评估报告</div>
			<div class="cs-item">				
				<ul class="cs-ul">
					<li class="cs-li"><span class="cs-item-1">囚号</span><span
						class="cs-item-2" id="rcpgqh"></span></li>
					<li class="cs-li"><span class="cs-item-1">姓名</span><span
						class="cs-item-2" id="rcpgxm"></span></li>
            ...
            <div class="cs-item cs-item-l">
				<div>
					<table class="cs-tb-w cs-tb-cl" style="text-align: center;line-height: 22px;width:100%;">
						...
						<tr class="trcolor">
							<td>自杀</td>
							<td><font id="rczsfs" class="dfcolor"></font></td>
							<td><font id="rczslx" class="dfcolor"></font></td>
						</tr>
						<tr class="trcolor">
							<td>脱逃</td>
							<td><font id="rcttfs" class="dfcolor"></font></td>
							<td><font id="rcttlx" class="dfcolor"></font></td>
						</tr>
						<tr class="trcolor">
							<td>行凶</td>
							<td><font id="rckgfs" class="dfcolor"></font></td>
							<td><font id="rckglx" class="dfcolor"></font></td>
						</tr>
					</table>
			...
			<div class="cs-item cs-item-l">
				<div>
					...
					<div style="margin-left: 75%;">
						<a><strong>档案分析总分：<font id="rcdafxzf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
					</div>
				</div>
				</div>
				...
				<div>
					...
					<div style="margin-left: 75%;">
							<a><strong>访谈调查总分：<font id="rcftdczf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
					</div>
				</div>
				</div>
				...
				<div>
					<table class="cs-tb-w cs-tb-cl" style="text-align: center;line-height: 22px;width:100%;">
						...
						<tr id="rcxwgcaddbefore">
							<td></td>
							<td></td>
						</tr>
					</table>
					<div style="margin-left: 75%;">
							<a><strong>行为观察总分：<font id="rcxwgczf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
						</div>
				</div>
				</div>
				...
				<div>
					...
					<div style="margin-left: 75%;">
							<a><strong>心理测试总分：<font id="xlcszf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
						</div>
				</div>
				</div>
				<div class="cs-item">
