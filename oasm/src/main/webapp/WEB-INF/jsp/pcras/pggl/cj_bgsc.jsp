		...
		<div class="search_title">筛选条件：</div>
			...
			<fieldset class="instruct">
				<table class="search_tb">
					<tr>
						<th>监&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;区</th>
						<td><select id="cjbg_ss_selected" class="search_tb_select">
					<option value="">全监区</option>
					<option value="十监区">十监区</option>
					<option value="出监管区">出监管区</option>
				</select></td>
						<th>囚&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号</th>
						<td><input type="text" id="cjbgqh" class="search_tb_input" /></td>
						<th>罪&nbsp;&nbsp;犯&nbsp;&nbsp;姓&nbsp;&nbsp;名</th>
						<td><input type="text" id="cjbgxm" class="search_tb_input" /></td>
						<th>警&nbsp;&nbsp;察&nbsp;&nbsp;姓&nbsp;&nbsp;名</th>
						<td><input type="text" id="cjbgjhxm" class="search_tb_input" /></td>
					</tr>
					<tr>
						<th>评&nbsp;&nbsp;估&nbsp;&nbsp;状&nbsp;&nbsp;态</th>
						<td colspan="2" id="cjbg_ss_statRadio"><input type="radio" name="wcqk" value="" id="status_all" checked/> <label for="status_all">全部 </label>
				    ...
				    <input type="radio" name="wxdj" value="低度危险" id="wxdj_d" /><label for="wxdj_d">低度危险</label>
						...
						<td><button class="button_submit2" id="cjbg_ss_btn">&nbsp;搜&nbsp;&nbsp;索&nbsp;</button></td>
					</tr>
					</table>
			</fieldset>
		</div>
...
<script type="text/javascript" src="<c:url value='/resource/js/pggl/cjpgbglist.js'/>"></script>
