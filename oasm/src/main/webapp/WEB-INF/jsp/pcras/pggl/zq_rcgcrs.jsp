...
<body>
	...
	<div id="printcontent">
       ...
       <div class="msg_div2">
		   ...
		   <li class="xx_li02">${zqzygc.xm }</li>
		   <li class="xx_li01">囚<span>号</span>：</li>
		   <li  class="xx_number xx_li02" onclick="loadnext3('/oasm/dafxView/criminalinfo?qh=${zqzygc.qh }')">${zqzygc.qh }</li>
		   <li class="xx_li01">录入时间：</li>
		   <li class="xx_li02">${gcsj }</li>
		   <li class="xx_li01">监<span>区</span>：</li>
		   <li class="xx_li02">${zqzygc.gyjq }</li>
		   <li class="xx_li01">分监区：</li>
		   <li class="xx_li02">无数据</li>
		   <li class="xx_li01">专管警察：</li>
		   <li class="xx_li02">${zqgcjyxx.jhxm }</li>
