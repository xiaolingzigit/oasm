		...
		<div class="base_table cs-table" style="overflow-x: auto; overflow-y: auto; height: 500px;">
			<table>
				...
				<tr>
					<td>1</td>
					<td>认罪悔罪</td>
					<td class="lb_td04" style="text-align: left;"><br>
					<input name="question1" type="radio" value="" />服从法院判决，认罪悔罪，民事赔偿及罚金等履行完毕<br>
				...
				<tr>
					...
					<td>婚姻状况</td>
					<td class="lb_td04" style="text-align: left;"><br>
					<input name="question6" type="radio" value="" />未婚或已婚且关系稳定 <br>
					<input name="question6" type="radio" value="" />已婚，婚姻关系不太稳定 <br>
				...
				<tr>
					...
					<td>家庭经济</td>
					<td class="lb_td04" style="text-align: left;"><br>
					<input name="question7" type="radio" value="" />好 <br>
					<input name="question7" type="radio" value="" />较好 <br>
					<input name="question7" type="radio" value="" />一般 <br>
					<input name="question7" type="radio" value="" />较差 <br>
					<input name="question7" type="radio" value="" />差</td>
				</tr>
				<tr>
					<td>4</td>
					<td>亲情关系</td>
					<td class="lb_td04" style="text-align: left;"><br>
					<input name="question8" type="radio" value="" />亲情关系稳定 <br>
					<input name="question8" type="radio" value="" />亲情关系一般 <br>
					<input name="question8" type="radio" value="" />亲情关系较差 <br>
					<input name="question8" type="radio" value="" />三无人员</td>
				</tr>
				...
				<tr>
					...
					<td>就业前景情况</td>
					<td class="lb_td04" style="text-align: left;"><br>
					<input name="question12" type="radio" value="" />有就业计划，完全有把握就业 <br>
					<input name="question12" type="radio" value="" />有就业计划，基本有把握就业，预期收入基本满足需要
						<br>
					<input name="question12" type="radio" value="" />无就业计划，希望找到工作，但没有把握
						<br>
					<input name="question12" type="radio" value="" />刑满释放不能找到工作或根本不想找到工作
					</td>
				</tr>
				<tr>
					<td>6</td>
					<td>社会环境及关系</td>
					<td class="lb_td04" style="text-align: left;"><br>
					<input name="question13" type="checkbox" value="" />社会环境及社会关系好，对其安置就业有帮助的

						<br>
					<input name="question13" type="checkbox" value="" />社会环境及社会关系一般，对其安置就业有较大影响的
		...
		setTimeout(function() {
			...
			$('.lb_td04 input').click(
					function(event) {
						...
						if (typ == "radio") {
							$("input[name=" + nam + "]").next().removeClass(
									'factor_selected');
						}
