...
<body>
    <div class="return_btn" >
       <a href="#" onclick="loadnext3('/oasm/dafxView/cj_rcgc')"> <<<  返回 </a>	
    </div>
     <div class="rs_table">
  	<div id="printcontent">
        <div class="rs_table_title"><h1>出监行为观察结果表</h1></div>
        <div class="msg_div2">
		   <ul  class="xx_ul">
		   <li class="xx_li01">姓<span>名</span>：</li>
		   <li class="xx_li02">${cjgczyry.xm }</li>
		   <li class="xx_li01">囚<span>号</span>：</li>
		   <li  class="xx_number xx_li02" onclick="loadnext3('/oasm/dafxView/criminalinfo?qh=${cjgczyry.qh }')">${cjgczyry.qh }</li>
		   <li class="xx_li01">录入时间：</li>
		   <li class="xx_li02">${gcsj}</li>
		   <li class="xx_li01">监<span>区</span>：</li>
		   <li class="xx_li02">${cjgczyry.gyjq }</li>
		   <li class="xx_li01">分监区：</li>
		   <li class="xx_li02">无数据</li>
		   <li class="xx_li01">专管警察：</li>
		   <li class="xx_li02">${cjgcjyxx.jhxm }</li>
           <li  class="xx_li01">分析结果：</li>
		   <li class="xx_li02" ></li>
           <li class="xx_li01">得<span>分</span>：</li>
		   <li class="xx_li02" >${gcfs }</li>	
		   </ul>	
        </div>
 ...
 -->
		...
		<div class="lb_zf">总得分：<span><!-- 拼接回来的出监观察答题分数 --></span></div>
</div>
