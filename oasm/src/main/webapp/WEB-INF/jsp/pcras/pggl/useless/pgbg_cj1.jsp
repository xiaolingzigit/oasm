...
<!-- 功能子块-->
	...
	<div class="main_content">
		<div class="cs-jc-title">罪犯出监危险性评估报告</div>
		<div class="cs-item">
			<ul class="cs-ul">
				<li class="cs-li"><span class="cs-item-1">囚号</span><span
					class="cs-item-2" id="cjpgqh"></span></li>
				<li class="cs-li"><span class="cs-item-1">姓名</span><span
					class="cs-item-2" id="cjpgxm"></span></li>
		...
		<div class="cs-item cs-item-l">
			<div>
				<table class="cs-tb-w cs-tb-cl"
					style="text-align: center; height: 70px; width: 100%;">
					<tr style="color: #ffffff">
						<td rowspan="2" width="10%"><strong><a
								class="ztsize">再犯罪分析</strong></td>
						<td width="20%">分数</td>
						<td width="20%">危险程度</td>
					</tr>
					<tr class="trcolor">
						<td><font id="zfzfs" class="dfcolor"></font></td>
						<td><font id="zfzlx" class="dfcolor"></font></td>
					</tr>
				</table>
		...
		<div class="cs-item cs-item-l">
			<div>
				<table class="cs-tb-w cs-tb-cl"
					...
					<tr style="color: #ffffff">
						<td rowspan="16" width="10%"><strong><a
								class="ztsize">档</br>案</br>分</br>析
							</a></strong></td>
						<td width="60%">因子</td>
						<td width="20%">分数</td>
					</tr>
					<tr id="cjdafxaddbefeore">
						<td></td>
						<td></td>
					</tr>
				</table>
				<div style="margin-left: 75%;">
					<a><strong>档案分析总分：<font id="cjdafxzf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
				</div>
			</div>
		</div>
		...
		<div class="cs-item cs-item-l">
			<div>
				<table class="cs-tb-w cs-tb-cl"
					style="text-align: center; line-height: 22px; width: 100%;">
					<tr>
						<td rowspan="18" width="10%"><strong><a
								class="ztsize">访</br>谈</br>调</br>查
							</a></strong></td>
						<td width="60%">因子</td>
						<td width="20%">分数</td>
					</tr>
					<tr id="cjftdcaddbefore">
						<td></td>
						<td></td>
					</tr>
				</table>
				<div style="margin-left: 75%;">
					<a><strong>访谈调查总分：<font id="cjftdczf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
				</div>
			</div>
		</div>
		...
		<div class="cs-item cs-item-l">
			<div>
				<table class="cs-tb-w cs-tb-cl"
					style="text-align: center; line-height: 22px; width: 100%;">
					<tr>
						<td rowspan="10" width="10%"><strong><a
				...
				<div style="margin-left: 75%;">
					<a><strong>心理测试总分：<font id="cjxlcezf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
				</div>
			</div>
		</div>
		<div class="cs-item">
