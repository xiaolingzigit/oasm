...
<!-- 功能子块-->
	<div class="main_content">
		<div class="cs-jc-title">罪犯入监危险性评估报告</div>
		<div class="cs-item">
			<ul class="cs-ul">
				<li class="cs-li"><span class="cs-item-1">囚号</span><span
					class="cs-item-2" id="rjpgqh"></span></li>
				<li class="cs-li"><span class="cs-item-1">姓名</span><span
					class="cs-item-2" id="rjpgxm"></span></li>
		...
		<div class="cs-item cs-item-l">
			<div>
				<table class="cs-tb-w cs-tb-cl"
					style="text-align: center; line-height: 22px; width: 100%;">
					<tr style="color: #ffffff">
						<td rowspan="4" width="10%"><strong><a
								class="ztsize">危险</br>类型</br>分析</strong></td>
						<td width="40%">危险类型</td>
						<td width="20%">分数</td>
					...
					<tr class="trcolor">
						<td>自杀</td>
						<td><font class="dfcolor" id="rjzsfs"></font></td>
						<td><font class="dfcolor" id="rjzslx"></font></td>
					</tr>
					<tr class="trcolor">
						<td>脱逃</td>
						<td><font class="dfcolor" id="rjttfs"></font></td>
						<td><font class="dfcolor" id="rjttlx"></font></td>
					</tr>
					<tr class="trcolor">
						<td>行凶</td>
						<td><font class="dfcolor" id="rjkgfs"></font></td>
						<td><font class="dfcolor" id="rjkglx"></font></td>
					</tr>
				</table>
		...
		<div class="cs-item cs-item-l">
			<div>
				<table class="cs-tb-w cs-tb-cl"
					style="text-align: center; line-height: 22px; width: 100%;">
					<tr id="dayz" style="color: #ffffff">
						<td rowspan="30" width="10%"><strong><a
								class="ztsize">档</br>案</br>分</br>析
							</a></strong></td>
						<td width="60%">因子</td>
						<td width="20%">分数</td>
					</tr>
				...
				<div style="margin-left: 75%;">
					<a><strong>档案分析总分：<font color="FF0000" id="dazf">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
				</div>
			</div>
		</div>
		...
		<div class="cs-item cs-item-l">
			<div>
				...
				<div style="margin-left: 75%;">
					<a><strong>访谈调查总分：<font id="ftdczf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
				</div>
			</div>
		</div>
		...
		<div class="cs-item cs-item-l">
			<div>
				...
				<div style="margin-left: 75%;">
					<a><strong>行为观察总分：<font id="xwgczf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
				</div>
			</div>
		</div>
		...
		<div class="cs-item cs-item-l">
			<div>
				<table class="cs-tb-w cs-tb-cl"
					style="text-align: center; line-height: 22px; width: 100%;">
					<tr>
						<td rowspan="20" width="10%"><strong><a
								class="ztsize">心</br>理</br>测</br>试
							</a></strong></td>
						<td width="60%">因子</td>
						<td width="20%">分数</td>
					</tr>
				...
				<div style="margin-left: 75%;">
					<a><strong>心理测试总分：<font id="xlcezf" color="FF0000">&nbsp;&nbsp;&nbsp;&nbsp;</font></strong></a>
				</div>
			</div>
		</div>
		<div class="cs-item">
		...
		<div class="cs-item cs-item-l">
			...
			<div>
				<table class="cs-tb-w cs-tb-cl"
					style="text-align: center; width: 98.5%;">
					<tr>
						<th>警号</th>
						<th>警察</th>
						<th>时间</th>
