...
<body>
	...
	<div id="printcontent">
       ...
       <div class="msg_div2">
		   ...
		   <li  class="xx_number xx_li02" onclick="loadnext3('/oasm/dafxView/criminalinfo?qh=${cjftzyry.qh }')">${cjftzyry.qh }</li>
...
<!-- 			<ul>
		...
		<table>
			...
			<div class="lb_zf">总得分：<span><!-- 拼接回来的出监结构访谈答题总分 --></span></div>
</div>
