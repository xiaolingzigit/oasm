...
<div class="bg">
	<div class="cont">
		...
		<div class="c2">
		      <a class="re">返回页面</a>
		      <a href="<c:url value='/index.jsp'/>" class="home">重新登录</a>
		      <a href="http://www.baidu.com" class="sr">搜索一下页面相关信息</a>
		</div>
		<div class="c3">
		      <a href="http://www.shejicool.com" class="c3">系统</a>
		      <span>提醒您 - 您可能输入了错误的网址，或者该网页已删除或移动</span>
		</div>
	</div>
</div>
</body>
