...
<div class="bg">
	<div class="cont">
	    <font class="font">500</font>
		<div class="c1">
		  <img src='<c:url value="/resource/img/01.png"/>' class="img1" />
	    </div>
		 <h2>哎呀......http请求出错了!</h2>
		<div class="c2"><a class="re">返回页面</a></div>
		<div class="c3"><a href="http://www.shejicool.com" class="c3">系统</a>提醒您 - 您的服务器发生了异常</div>
	</div>
</div>
</body>
</html>