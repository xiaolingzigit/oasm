...
public class DateUtil {
    ...
    private static SimpleDateFormat cnsdf = new SimpleDateFormat("yy年MM月dd天");
    ...
    public static String fmtDate(String dateName) throws Exception{
    	...
    	try {
			...
			throw new Exception("不是6位数的时间格式");
		}
    	return fmtDate;
    }
