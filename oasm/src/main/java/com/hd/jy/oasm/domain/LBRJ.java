 ...
 * 
 * @author quite
 *入监因子量表 对应入监时所使用到的结构访谈，行为观察等答题情况使用
 *
 *存到到量表库LBKM中
 */
public class LBRJ {
    private String rjlbbh;  //入监量表编号
	...
	public String getRjlbbh() {
        return rjlbbh;
    }

    public void setRjlbbh(String rjlbbh) {
        this.rjlbbh = rjlbbh == null ? null : rjlbbh.trim();
    }
